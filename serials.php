...
include("php/connect_mssql_db.php");
  ...
  $pages=ceil(getCountSerials($conn)/$items);
  include('php/pagination.php');
  $result = getSerials($conn,$start,$end);
  include("php/content.php");
  sqlsrv_close($conn);
?>
<html>
  <head>
    <title>Кинокаталог - Сериалы</title>
      ...
      <div class="navbar navbar-inverse">
        <div class="navbar-inner">
          <ul class="nav">
            ...
            <li><a class="active" href="serials.php">Сериалы</a></li>
    ...
    <div class="container" style="width:940px;">
      <div class="span3">
            ...
            <div class='pagination pagination-centered' style="margin-top:5px;">
              <ul>
              <li><a id="3" href='serials.php?row_on_page=3'>3</a></li>
              <li><a id="5" href='serials.php?row_on_page=5'>5</a></li>
              <li><a id="7" href='serials.php?row_on_page=7'>7</a></li>
              </ul>
            </div>
      </div>
