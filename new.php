...
include("php/connect_mssql_db.php");
  ...
  $result = getNewAdded($conn,$start,$end);
  include("php/content.php");
sqlsrv_close($conn);
?>
<html>
  <head>
    <title>Кинокаталог - новинки кино</title>
    ...
    <div class="container" style="width:940px;">
      <div class="span3">
            <ul id="vertMenu" class="nav nav-tabs nav-stacked" >
              <li><a id="active" href="new.php"> Новинки кино</a></li>
            ...
            <div class='pagination pagination-centered' style="margin-top:5px;">
              <ul>
              <li><a id="3" href='new.php?row_on_page=3'>3</a></li>
              <li><a id="5" href='new.php?row_on_page=5'>5</a></li>
              <li><a id="7" href='new.php?row_on_page=7'>7</a></li>
              </ul>
            </div>
      </div>
