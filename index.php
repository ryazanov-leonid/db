...
<html>
  <head>
    <meta charset="utf-8">
    <title>Кинокаталог - Главная</title>
    ...
    <div class="container" style="width:940px;">
      <div class="navbar navbar-inverse">
        <div class="navbar-inner">
          <ul class="nav">
            <li><a class="active"  href="index.php"><i class="icon-home icon-white"> </i> Главная</a></li>
            <li><a href="films.php">Фильмы</a></li>
            <li><a href="serials.php">Сериалы</a></li>
            <li><a href="login.php">Admin</a></li>
            <li  style="margin-left: 260px;"> <label style="margin-bottom: 0px; padding: 10px; padding-right: 0px;" class="control-label" for="inputIcon">Поиск</label></li>
            <li>
    ...
    <div class="container" style="width:940px;">
      <div class="span3">
            ...
            <div class='pagination pagination-centered' style="margin-top:5px;">
              <ul>
              <li><a id="3" href='index.php?row_on_page=3'>3</a></li>
              <li><a id="5" href='index.php?row_on_page=5'>5</a></li>
              <li><a id="7" href='index.php?row_on_page=7'>7</a></li>
              </ul>
            </div>
      </div>
      ...
      <div id="go_to_bottom" class="go_to_top" title="Вниз" style=" right: 133px; bottom: 115px;"><a href="#"><img src="img/go_to_top_small.png"></a></div>
      <div class="span9">
        <div id="info"> 
          <ul class="list_info">
            ...
            <li class="elem_list"><a href="#">Администратор</a></li>
