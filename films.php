<?php
  ...
  $pages=ceil(getCountFilms($conn)/$items);
  include('php/pagination.php');
  $result = getFilms($conn,$start,$end);
  include("php/content.php");
  sqlsrv_close($conn);
?>
<html>
  <head>
    <title>Кинокаталог - Фильмы</title>
      ...
      <div class="navbar navbar-inverse">
        <div class="navbar-inner">
          <ul class="nav">
            ...
            <li><a class="active" href="films.php">Фильмы</a></li>
    ...
    <div class="container" style="width:940px;">
      <div class="span3">
            ...
            <div class='pagination pagination-centered' style="margin-top:5px;">
              <ul>
              <li><a id="3" href='films.php?row_on_page=3'>3</a></li>
              <li><a id="5" href='films.php?row_on_page=5'>5</a></li>
              <li><a id="7" href='films.php?row_on_page=7'>7</a></li>
              </ul>
            </div>
      </div>
